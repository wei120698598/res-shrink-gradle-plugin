package com.planb.webp.proguard.arsc;
...
import com.planb.webp.proguard.io.ZInput;
import com.planb.webp.proguard.io.ZOutput;
...
//	private static final short CHECK_PACKAGE = 0x0200;
    ...
    private com.planb.webp.proguard.arsc.Header mHeader;
    ...
    private static void write(ZOutput out, ArscFile arsc) throws IOException {
        ...
        out.writeShort(com.planb.webp.proguard.arsc.Header.TYPE_TABLE);
    ...
    private void readTable() throws IOException {
        ...
        checkChunk(type, com.planb.webp.proguard.arsc.Header.TYPE_TABLE);
...
//        value = new ArscValue[constantPool.size()];
    ...
    com.planb.webp.proguard.arsc.Header nextChunk() throws IOException {
