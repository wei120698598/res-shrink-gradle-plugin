...
import com.planb.webp.proguard.zip.encoding.ZipEncoding;
import com.planb.webp.proguard.zip.encoding.ZipEncodingHelper;
import com.planb.webp.proguard.zip.exception.Zip64RequiredException;
import com.planb.webp.proguard.zip.extrafiled.UnicodeCommentExtraField;
import com.planb.webp.proguard.zip.extrafiled.UnicodePathExtraField;
import com.planb.webp.proguard.zip.extrafiled.Zip64ExtendedInformationExtraField;
import com.planb.webp.proguard.zip.util.GeneralPurposeBit;
import com.planb.webp.proguard.zip.util.Zip64Mode;
import com.planb.webp.proguard.zip.util.ZipConstants;
import com.planb.webp.proguard.zip.util.ZipEightByteInteger;
import com.planb.webp.proguard.zip.util.ZipLong;
import com.planb.webp.proguard.zip.util.ZipShort;
import com.planb.webp.proguard.zip.util.ZipUtil;

import static com.planb.webp.proguard.zip.encoding.ZipEncodingHelper.getZipEncoding;
import static com.planb.webp.proguard.zip.util.ZipLong.putLong;
...
public class ZipOutputStream extends FilterOutputStream {
     ...
     * #setEncoding(String)}.
     */
    private ZipEncoding zipEncoding = getZipEncoding(DEFAULT_ENCODING);
   ...
   // CheckStyle:VisibilityModifier OFF - bc
    ...
    public void setEncoding(final String encoding) {
        ...
        this.zipEncoding = getZipEncoding(encoding);
...
//        setDefaults(entry.entry);
    ...
    private byte[] createCentralFileHeader(ZipEntry ze, ByteBuffer name, long lfhOffset,
        ...
        putLong(Math.min(lfhOffset, ZipConstants.ZIP64_MAGIC), buf, CFH_LFH_OFFSET);
