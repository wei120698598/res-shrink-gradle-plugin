 ...
 *
 */
package com.planb.webp.proguard.zip.util;

import com.planb.webp.proguard.zip.ZipEntry;
import com.planb.webp.proguard.zip.encoding.ZipEncodingHelper;
import com.planb.webp.proguard.zip.exception.UnsupportedZipFeatureException;
import com.planb.webp.proguard.zip.extrafiled.AbstractUnicodeExtraField;
...
public abstract class ZipUtil {
     ...
     */
    public static void setNameAndCommentFromExtraFields(com.planb.webp.proguard.zip.ZipEntry ze,
     ...
     */
    public static boolean canHandleEntryData(com.planb.webp.proguard.zip.ZipEntry entry) {
     ...
     */
    private static boolean supportsEncryptionOf(com.planb.webp.proguard.zip.ZipEntry entry) {
     ...
     */
    private static boolean supportsMethodOf(com.planb.webp.proguard.zip.ZipEntry entry) {
        return entry.getMethod() == com.planb.webp.proguard.zip.ZipEntry.STORED
                || entry.getMethod() == com.planb.webp.proguard.zip.ZipEntry.DEFLATED;
    }
